...
const cardKeys = ["account", "proxy", "connection", "themes", "api"] as const;
              ...
              <CollapsibleCard {...this.cardProps.themes}>
                <header>
                  <CollapsibleCardHeading
                    onCollapseToggled={this.cardProps.themes.onCollapseToggled}
                  >
                    Themes
                  </CollapsibleCardHeading>
                </header>
                <TabbedOptionsContainer>
                  ...
                  >
                    <Tab icon={["fas", "sun"]} value="light">
                      Light
                    </Tab>
                    <Tab icon={["fas", "moon"]} value="dark">
                      Dark
                    </Tab>
                    <Tab icon={["fas", "adjust"]} value={"high-contrast"}>
                      High Contrast
                    </Tab>
                  </TabsContainer>
                  <ThemeColors>
